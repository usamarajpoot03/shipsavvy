...
const PrivacyPolicy = ({ history }) => {
  const socialLoginsRef = useRef(null);
  const shareInfoRef = useRef(null);

  const socialLoginsScroll = () => socialLoginsRef.current.scrollIntoView();
  const shareInfoScroll = () => shareInfoRef.current.scrollIntoView();
  ...
  return (
    <div className="privacy-policy-component">
      ...
      <div className="privacy-terms-body">
        <p>
          Thank you for choosing to be part of our community at ZeroDocs.com,
          ...
          at info@zerodocs.com.
        </p>
        <p>
          When you and more generally, use any of our services (the "
          <strong>Services</strong>", which include the ), we appreciate that
        ...
        <strong className="text-lightBlueColor2 primary-span">
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              public areas of the , such personal information may be viewed by
        ...
        <h5 ref={socialLoginsRef}>4. HOW DO WE HANDLE YOUR SOCIAL LOGINS? </h5>
        <p>
          {" "}
          <i>
            <strong className="text-lightBlueColor2 primary-span">
        ...
        <h5>5. IS YOUR INFORMATION TRANSFERRED INTERNATIONALLY? </h5>
        <p>
          {" "}
          <i>
            <strong className="text-lightBlueColor2 primary-span">
        ...
        <p>
          ...
          will require us keeping your personal information for longer than 60
          days after cancellation of service.
        </p>
        <p>
        ...
        <p>
          <strong
            className="text-lightBlueColor2 primary-span"
            style={{ textDecoration: "underline" }}
          >
        ...
        <h5>11. DO WE MAKE UPDATES TO THIS NOTICE?</h5>
        <p>
          {" "}
          <i>
            <strong className="text-lightBlueColor2 primary-span">
        ...
        <h5>12. HOW CAN YOU CONTACT US ABOUT THIS NOTICE? </h5>
        <p>
        ...
        <p>
          ...
          <span className="text-primary">emailing: info@zerodocs.com</span>. We
